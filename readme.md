...
- Get the [Contract Code](https://gist.github.com/Sunlight1026/05005b4c1e9c402e521be8b56d8050f2)
...
- Click `Continue` and put `Contract Code` from `Remix IDE` or [Gist](https://gist.github.com/Sunlight1026/05005b4c1e9c402e521be8b56d8050f2)
...
```
git clone https://github.com/Sunlight1026/Decentralized-Lottery-App
```
